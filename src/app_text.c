...
/* BEGINTEXT */
texts[0] = "GSS: LocServ BB - Bridgetown 7 User\nGSS: LocServ BR - São Paulo 206 User\nGSS: LocServ CA - Toronto 216 User\nGSS: LocServ MX - Mexico City 144 User\nGSS: LocServ USA - Alpharetta 68 User\nGSS: LocServ USA - Armonk 935 User\nGSS: LocServ USA - Boise 3 User\nGSS: LocServ USA - Calabasas 61 User\nGSS: LocServ USA - Chicaco 90 User\nGSS: LocServ USA - Dallas 28 User\nGSS: LocServ USA - Fort Wayne 227 User\nGSS: LocServ USA - Hiawatha 5 User\nGSS: LocServ USA - Manchester 52 User\nGSS: LocServ USA - Miami 51 User\nGSS: LocServ USA - Needham 5 User\nGSS: LocServ USA - New York 365 User\nGSS: LocServ USA - Overland Park 431 User\nGSS: LocServ USA - San Francisco 24 User\nGSS: LocServ USA - Schaumburg 104 User\nGSS: LocServ USA - Southfields 7 User\nGSS: LocServ USA - Windsor 69 User\n"; 
texts[1] = "GSS: Location-based AU - Sydney 170 User\nGSS: Location-based CN - Beijing 108 User\nGSS: Location-based HK - Hongkong 221 User\nGSS: Location-based IN - Bangalore (ODC) 941 User\nGSS: Location-based IN - Chennai (ODC)  119 User\nGSS: Location-based IN - Gurgaon (ODC) 353 User\nGSS: Location-based IN - Hyderabad (ODC) 46 User\nGSS: Location-based IN - Mumbai 40 User\nGSS: Location-based JP - Tokyo 78 User\nGSS: Location-based KP - Seoul 34 User\nGSS: Location-based MY - Kuala Lumpur 14 User\nGSS: Location-based SG - Singapore 182 User\n"; 
texts[2] = "GSS: LocServ other locations 598 User\nGSS: LocServ AE - Dubai 9 User\nGSS: LocServ CH - Zurich 3847 User\nGSS: LocServ DE - Munich 564 User\nGSS: LocServ DK - Copenhagen 24 User\nGSS: LocServ ES - Madrid 21 User\nGSS: LocServ FR - Paris 70 User\nGSS: LocServ GB - Folkestone 138 User\nGSS: LocServ GB - Gloucester 22 User\nGSS: LocServ GB - Hitchin 17 User\nGSS: LocServ GB - London 899 User\nGSS: LocServ GB - Telford 146 User\nGSS: LocServ IL - Tel Aviv 14 User\nGSS: LocServ IT - Milano 6 User\nGSS: LocServ IT - Rome 47 User\nGSS: LocServ LU - Luxembourg 28 User\nGSS: LocServ LV - Riga 264 User\nGSS: LocServ NL - Amstelveen 28 User\nGSS: LocServ SA - Cape Town 48 User\nGSS: LocServ SK - Bratislava 719 User"; 
texts[3] = "GSS: WP_HW Light Notebook Hardware Package 4184 Device\nGSS: WP_HW Loan Desktop PC 138 Device\nGSS: WP_HW Loan Mobile Phone 10 Device\nGSS: WP_HW Loan Notebook 378 Device\nGSS: WP_HW Power Desktop Hardware Package 2394 Device\nGSS: WP_HW Standard Desktop Hardware Package 604 Device\nGSS: WP_HW Standard Notebook Hardware Package 7089 Device"; 
texts[4] = "GSS: Non-Employee Lifecycle Services\nEmployee Off-boarding 359 Request\nGSS: Non-Employee Lifecycle Services\nEmployee On-boarding 305 Request\nGSS: Non-Employee Lifecycle Services\nEmployee Transfer 38 Request\nGSS: Non-IT Support Add-on Services\nPremium Support - Executive Add-on 75 User\nGSS: Non-IT Support Add-on Services\nPremium Support - Line of Business Add-on 29 User\nGSS: Non-IT Support Base Services\nIT Customer Service Package 12913 User\nGSS: Non-Organisation & Project Data Services\nShared folders for Organisational- & Project Teams 220370 Gigabyte\nGSS: Non-Organisation & Project Data Services\nTeam Mailbox/Database Data 6964 Gigabyte\nGSS: Non-Organisation & Project Data Services\nTeam Lotus Notes Mailbox/Database 3005 Mailbox"; 
texts[5] = "GSS: PersWP - Mobile & Smartphone Services\nAccess to email  calendar and contacts for private iPhones/iPads 2765 Device\nGSS: PersWP - Mobile & Smartphone Services\nCorporate mobile phone corporate service (incl SIM/voice plan) 5328 Device\nGSS: PersWP - Mobile & Smartphone Services\nCorporate BlackBerry with access to email  calender and contacts 3356 Device\nGSS: PersWP - Personal IT Workplace Core Services\nPersonal Data Directory 71559 Gigabyte\nGSS: PersWP - Personal IT Workplace Core Services\nPersonal Mail Data 55871 Gigabyte\nGSS: PersWP - Personal IT Workplace Core Services\nIT User base package 12913 User\n GSS: PersWP - Personal IT Workplace Core Services\nIT User extension add-on 12870 User\n GSS: PersWP - Personal IT Workplace Solution Add-ons\nRemote Access for Notebook Add-on 11282 Device\nGSS: PersWP - Personal IT Workplace Solution Add-ons\nIndividual Software Packages Add-on 716026 SW Package\nGSS: PersWP - Personal IT Workplace Solution Add-ons\nPrinter@home Add-on 24 User\nGSS: PersWP - Personal IT Workplace Solution Add-ons\nTrader Package Add-on 55 User";
